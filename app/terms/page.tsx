...
export const metadata = {
  title: "Terms & Conditions — Scoravo",
};
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">1. About Scoravo</h2>
            <p>
              Scoravo (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is an independent online practice platform that provides
              IELTS and PTE Academic preparation materials. Scoravo is not affiliated with, endorsed by,
          ...
          <section>
            ...
            <p>
              By creating an account or using Scoravo, you agree to these Terms &amp; Conditions. If you do
          ...
          <section>
            ...
            <p className="mb-3">Scoravo offers a Free plan and paid plans (Basic and Pro).</p>
            <ul className="list-disc list-inside space-y-2">
              <li>Free plan: limited to 3 reading practice tests per month.</li>
              <li>Basic plan ($5.99/month): unlimited reading tests and 3 writing tests per month.</li>
              <li>Pro plan ($9.99/month or $24.99 for 3 months): unlimited reading and writing tests, plus PDF score reports.</li>
              ...
              <li>All prices are in USD. Payments are processed securely through Stripe (cards, Google Pay, Apple Pay). We do not store your card details.</li>
          ...
          <section>
            ...
            <p>
              All practice passages, questions, model answers, and scoring content on Scoravo are original
          ...
          <section>
            ...
            <p>
              Scoravo is provided &quot;as is&quot; without any guarantees. Our band score estimates are
              ...
              differ. We do not guarantee that using Scoravo will result in any specific band score.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the extent permitted by law, Scoravo shall not be liable for any indirect, incidental,
