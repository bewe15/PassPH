    ...
    <div className="mb-8">
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/mock">
            <Card className="border-2 border-cyan-200 hover:border-cyan-400 transition cursor-pointer h-full">
              <CardContent className="py-5">
          ...
          <Link href="/pte-mock">
            <Card className="border-2 border-purple-200 hover:border-purple-400 transition cursor-pointer h-full">
              <CardContent className="py-5">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-bold px-2 py-0.5 rounded bg-purple-50 text-purple-700">PTE</span>
                      <span className="text-xs text-slate-500">Academic</span>
                    </div>
                    <p className="text-sm font-bold text-slate-900">PTE Academic Mock Exam</p>
                    <p className="text-xs text-slate-500 mt-1">
                      Real PTE order · Speaking → Writing → Reading → Listening · ~2.5 hrs
                    </p>
                    {plan !== "pro" && (
                      <p className="text-xs text-amber-600 font-medium mt-1.5">
                        Free: 1 mock exam per month · <span className="underline">Upgrade for unlimited</span>
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 text-purple-500">
                    <Shuffle className="w-4 h-4" />
                    <span className="text-sm font-semibold">Generate →</span>
                  </div>
                </div>
